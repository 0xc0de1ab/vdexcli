...
const (
	...
	TypeChar      PrimitiveType = "char"      // Single character
	...
	TypeLeb128    PrimitiveType = "leb128"    // Variable-length signed LEB128 integer
	TypeUleb128   PrimitiveType = "uleb128"   // Variable-length unsigned LEB128 integer
	TypeString    PrimitiveType = "string"    // String data (MUTF-8)
